...
export const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { label: "Azure Databricks" }, { label: "ADLS Gen2" }, { label: "Event Hubs" }, { label: "Key Vault" },
      { label: "Azure DevOps" }, { label: "ARM Templates" }, { label: "AKS", icon: "https://cdn.simpleicons.org/kubernetes/326CE5" },
      { label: "AWS Databricks" }, { label: "S3 / EC2" }, { label: "Amazon Bedrock" }, { label: "AWS IAM" },
